...
A Tabela de símbolos é criada a partir da Árvore de Sintaxe Abstrata, onde se percorre todos os nós relativos às declarações de métodos e atributos, sendo criada uma nova entrada na tabela para cada um deles. 
\subsubsection{Estruturas}
