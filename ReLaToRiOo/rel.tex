...
\lstset{language=C,caption={Estruturas para representação de Nós da Árvore},label=Estruturas}
\begin{lstlisting}
/* General Node */
...
\lstset{language=java,caption={Programa Exemplo},label=Estruturas}
\begin{lstlisting}
 class gcd {
...
\lstset{language=C,caption={Estruturas para representação da Tabela de Símbolos},label=Estruturas}
\begin{lstlisting}
/* Table Node */
...
\lstset{language=C,caption={Funções para tratamento de erros semânticos},label=Estruturas}
\begin{lstlisting}
