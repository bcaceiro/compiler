...
\begin{itemize}
		...
		"/*"	            {BEGIN COMMENT}
		\end{lstlisting}
		Caso seja detectado (/*) todo o código é ignorado até que seja encontrado o seu correspondente (*/). Caso seja detectado o EOF então é apresentada uma mensagem de erro: "Line \%d, col \%d: unterminated comment"
        ...
        Para a contagem de colunas aumentamos a variável consoante o tamanho de cada \emph{token}, quando há uma mudança de linha, inicializa-se o contador das colunas a 1. No caso dos comentários criámos duas variáveis adicionais (\emph{Commentline,Commentcolumn}) para poder guardar a coluna e linha onde o comentário é inicializado.
