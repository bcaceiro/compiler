...
\lstset{language=C,caption={Cabeçalho do programa gerado},label=Estruturas,frame=single}
\begin{lstlisting}
...
\lstset{language=Java,caption={Programa exemplo e código \emph{LLVM} gerado},label=Estruturas,frame=single}
\begin{lstlisting}
class gcd
{
	public static void main(String[] args) {
